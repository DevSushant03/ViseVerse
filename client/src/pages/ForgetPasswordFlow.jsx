...
import { Mail, Shield, CheckCircle, Eye, EyeOff, Lock, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-700 to-indigo-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Main Card */}
        <div className="rounded-3xl mt-20 p-8 shadow-2xl border" style={{
          ...
          {currentStep === 1 && (
            <>
              ...
              <div className="space-y-6">
                ...
                {error && (
                  <p className="text-red-300 text-sm text-center rounded-lg py-2 px-4" style={{
